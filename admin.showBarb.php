...
<body>
  <header>
    ...
    <li><a href="http://localhost/phpmyadmin"> PhpMyAdmin </a></li>
        <li><a class="active" href="admin.showBarb.php"> Show Barbers </a></li>
...
echo "<br><h2>Number of Barbers in Database = <b>".mysqli_num_rows($result)."</b></h2><br>";
echo "<table>
<tr>
<th>EmpID</th>
<th>Employee Name</th>
