  ...
  <header>
    <div class="main-nav-bar" id="header-bar">
      <ul class="main-nav">
        ...
        <li><a class="active" href="admin.showMem.php"> Show Customers </a></li>
...
<center><h1>Show Customers</h1><hr>
<?php
...
$sql="SELECT * FROM customer order by CustomersID ASC";
$result = mysqli_query($con,$sql);
echo "<br><h2>Number of Customers in Database = <b>".mysqli_num_rows($result)."</b></h2><br>";
echo "<table>
<tr>
<th>Customer ID</th>
